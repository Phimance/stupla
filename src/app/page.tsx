...
export default function Home() {
    ...
    return (
        <div style={{ width: '100%', minHeight: '100dvh', backgroundColor: '#000', position: 'relative', overflow: 'hidden', cursor: 'pointer' }}>
            ...
            <center>
                <motion.div style={{ position: 'relative', paddingTop: '3vh', width: 380, zIndex: 2, paddingBottom: '50px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
